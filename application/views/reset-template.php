    ...
    <tr>
        ...
        <td class="header container" bgcolor="#ffd400">
            ...
            <div class="content">
                <table bgcolor="">
                    <tr>
                        <td><img src="<?php echo site_url() ?>image/logo.png" /></td>
                        <td align="right"><h6 class="collapse">familyPlus</h6></td>
                    </tr>
                </table>
            </div>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <p>Phone: <strong>09030126762</strong><br/>
                                                        Email: <strong><a href="emailto:admin@familyPlus.com">admin@familyPlus.com</a></strong></p>

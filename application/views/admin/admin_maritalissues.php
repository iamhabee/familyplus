    ...
    <section class="content">
        ...
        <form id="login" action="<?php echo site_url() ?>user/issues" method="POST">
          ...
          <textarea style="margin: 3px 10px 0px 5px; width: 90%; height: 200px;" name="article" placeholder="Marital Issues Article"></textarea>
                ...
                <div class="col-md-8">
                  <div class="card">
                    <div class="card-body">
                        ...
                        <h6 class="card-subtitle mb-2 text-muted">created <?php echo ': '.  $username; ?></h6>
